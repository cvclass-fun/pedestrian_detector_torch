function script_process_rois_acf_ETH(varargin)
%% process ACF ROI boxes for the ETH dataset
% input arguments:
%     [1] - threshold for suppression of weak(er) boxes
%
fprintf('\n********************************************************')
fprintf('\n**** Start ETH ACF roi detection/extraction script. ****')
fprintf('\n********************************************************')
...
%% script complete
fprintf('\n------------------------------------------')
fprintf('\nETH ACF boxes processing script completed.')
fprintf('\n------------------------------------------\n')
end