function script_process_rois_edgeboxes_ETH(varargin)
%% process Edge boxes for the ETH dataset
% input arguments:
%     [1] - number of boxes per file
%     [2] - use aspect ratio value
%
fprintf('\n************************************************************')
fprintf('\n**** Start ETH Edgebox roi detection/extraction script. ****')
fprintf('\n************************************************************')
...
%% script complete
fprintf('\n------------------------------------------')
fprintf('\nETH Edgeboxes processing script completed.')
fprintf('\n------------------------------------------\n')
end