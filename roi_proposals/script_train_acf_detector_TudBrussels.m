function [detector] = script_train_acf_detector_TudBrussels( )
% Trains the ACF detector on the INRIA dataset.
%
fprintf('\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
fprintf('\n++++ Start Tud-Brussels ACF detector training script. ++++')
fprintf('\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
...
acf_prepare_training_data( {'inriaTrain', 'inriaTest'}, root_path );
...
%% script complete
fprintf('\n---------------------------------------------------')
fprintf('\nTud-Brussels ACF detector training script complete!')
fprintf('\n---------------------------------------------------\n')
end