...
opt.save_dir = paths.concat( opt.save_dir, 'Tud-Brussels', 'algorithms')
...
local url = 'http://www.vision.caltech.edu/Image_Datasets/CaltechPedestrians/datasets/TudBrussels/res/'
